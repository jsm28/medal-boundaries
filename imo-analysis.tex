...
\item Boundaries may be chosen independently, to make the number of
  ...
  to one sixth of the number of medals.
...
\item Finally, we consider minimising a deviation determined directly
  ...
  proportions.  (This is my preferred approach.)
\end{itemize}

The following list shows when in the past thirty years each of these
...
strict about these choices before then.

\begin{itemize}
\input{gen-gs-alg-list.tex}
\end{itemize}
